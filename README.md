...
4. The first time you launch Agentforce Vibes it runs through a setup process that takes some time. You see the message: “Agentforce Vibes is loading…”

### Configure your AI Coding Partner
1. If not open already, click the Agentforce icon “Agentforce vibes icon” in the Activity Bar.
2. Add a check to I agree to the terms.
...
1. At the bottom of the Agentforce Vibes window, ensure the Plan/Act toggle is set to Act.
...
1. Use the type your task here… input area to interact with Agentforce.
